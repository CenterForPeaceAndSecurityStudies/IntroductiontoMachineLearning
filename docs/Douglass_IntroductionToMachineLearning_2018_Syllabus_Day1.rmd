...
```{r}
precision(BreastCancer$Class_binary,
         BreastCancer$Class_binary)
precision(BreastCancer$Class_binary, Y_coin_fair)
precision(BreastCancer$Class_binary, Y_coin_unfair)
precision(BreastCancer$Class_binary, Y_coin_twoheaded)
```

### Recall

```{r}
recall(BreastCancer$Class_binary,
         BreastCancer$Class_binary)
recall(BreastCancer$Class_binary, Y_coin_fair)
recall(BreastCancer$Class_binary, Y_coin_unfair)
recall(BreastCancer$Class_binary, Y_coin_twoheaded) 
```
