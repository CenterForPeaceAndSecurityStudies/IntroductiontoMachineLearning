...
This guide is written as an [R notebook](https://bookdown.org/yihui/rmarkdown/notebook.html) using [R-Studio](https://www.rstudio.com/). It renders output as static HTML that you should be able to view on an regular browser.
...
```{r}
Y_hat=Y_coin_fair
table(Y_coin_unfair,Y_hat)
```

```{r}
p_load(Metrics)
accuracy(Y_coin_unfair, Y_hat)
```

* [Precision_and_recall](https://en.wikipedia.org/wiki/Precision_and_recall)<br/>
```{r}
precision(Y_coin_unfair, Y_hat)
```

* [F1_score](https://en.wikipedia.org/wiki/F1_score)<br/>
```{r}
f1(Y_coin_unfair, Y_hat)
```

* [Mutual_information](https://en.wikipedia.org/wiki/Mutual_information)<br/>
```{r}
print(natstobits(mutinformation(Y_coin_unfair, Y_hat, method="emp")))
```
...
* [Binary_number#Counting_in_binary](https://en.wikipedia.org/wiki/Binary_number#Counting_in_binary) <br/>
...
### LSTM
* Christopher Olah, "Understanding LSTM Networks," August 27, 2015, http://colah.github.io/posts/2015-08-Understanding-LSTMs/ <br/>
